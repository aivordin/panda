...
TOYOTA_COMMON_TX_MSGS = [[0x2E4, 0], [0x191, 0], [0x412, 0], [0x343, 2], [0x1D2, 0]]  # LKAS + LTA + ACC & PCM cancel cmds
TOYOTA_SECOC_TX_MSGS = [[0x131, 0], [0x183, 1], [0x411, 2], [0x750, 0]] + TOYOTA_COMMON_TX_MSGS
...
class TestToyotaSecOcSafety(TestToyotaSafetyBase):
  ...
  def _accel_msg_2(self, accel, cancel_req=0):
    ...
    return self.packer.make_can_msg_panda("ACC_CONTROL_2", 1, values)
